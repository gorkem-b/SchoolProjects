...
namespace Unity.FPS.UI
{
    ...
    public class AmmoCounter : MonoBehaviour
    {
        ...
        public void Initialize(WeaponController weapon, int weaponIndex)
        {
            ...
            GameObject bulletCounterRoot = BulletCounter != null && BulletCounter.transform.parent != null
                ? BulletCounter.transform.parent.gameObject
                : null;

            if (bulletCounterRoot != null)
                bulletCounterRoot.SetActive(weapon.HasPhysicalBullets);

            if (weapon.HasPhysicalBullets)
                BulletCounter.text = weapon.GetCarriedPhysicalBullets().ToString();
            else if (BulletCounter != null)
                BulletCounter.text = string.Empty;
