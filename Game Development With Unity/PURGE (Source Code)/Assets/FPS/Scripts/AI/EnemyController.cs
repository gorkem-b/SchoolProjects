...
namespace Unity.FPS.AI
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (m_Actor == null || m_SelfColliders == null)
                return;
        ...
        void OnDie()
        {
            ...
            if (DeathVfx != null)
            {
                Vector3 spawnPosition = DeathVfxSpawnPoint != null ? DeathVfxSpawnPoint.position : transform.position;
                var vfx = Instantiate(DeathVfx, spawnPosition, Quaternion.identity);
                Destroy(vfx, 5f);
            }
