/**
 * Implements a console-based quiz game that presents five multiple-choice questions
 * in random order, accepts user answers, validates them, tracks the score, and reports
 * the final result after all questions have been answered.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
