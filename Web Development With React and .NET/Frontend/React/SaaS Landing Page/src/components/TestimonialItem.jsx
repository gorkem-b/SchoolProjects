...
const TestimonialItem = ({ item, containerClassName }) => {
    return (
      ...
      <div className="flex items-center max-xl:-mr-8">
        <div className="mr-4 size-20 shrink-0 rounded-half border-2 border-s2 p-1.5 flex items-center justify-center bg-s2">
          <span className="text-2xl font-bold text-p1">{item.name.charAt(0)}</span>
        </div>
        <div>
