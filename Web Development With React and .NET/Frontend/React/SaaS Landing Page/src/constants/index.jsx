export const features = [
  {
    ...
    caption: "AI-Powered Editing",
    title: "Edit videos in minutes, not hours",
    text: "With Hume Editor, AI handles the heavy lifting — auto-cuts, scene detection, and smart transitions bring your footage to life faster than any traditional editor. Say goodbye to tedious timeline scrubbing.",
    button: {
  ...
  },
  {
    ...
    caption: "Cloud Rendering",
    title: "Render at lightning speed",
    text: "No more waiting hours for exports. Hume Editor's cloud-based rendering engine processes your 4K and 8K projects in a fraction of the time — all without taxing your local hardware.",
    button: {
...
export const details = [
  {
    ...
    title: "AI scene detection & auto-cut",
  },
  {
    id: "1",
...
export const faq = [
  {
    id: "0",
    question: "How easy is it to setup Hume Editor?",
    answer:
      "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
  },
  {
    id: "1",
    question: "Can I integrate Hume Editor with other platforms?",
    answer:
      "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
  },
  {
...
export const testimonials = [
  {
    ...
    avatarUrl: null,
    comment:
      "Hume Editor's customer support is second to none! They're like my tech superheroes, always there when I need them.",
  },
  {
    id: "1",
    name: "MBOT",
    ...
    avatarUrl: null,
    comment:
      "I was skeptical at first, but now I can't imagine editing without it. The AI auto-cut saves me hours every week.",
  },
  {
    id: "2",
    name: "NovaBot",
    ...
    avatarUrl: null,
    comment:
      "Switching from Premiere Pro was seamless. Hume Editor is faster, cheaper, and the AI features are unmatched.",
  },
  {
    id: "3",
    name: "ZenBot",
    role: "Film Production Co.",
    avatarUrl: null,
    comment:
      "The cloud rendering is a game-changer. We exported a 4K short film in minutes instead of hours.",
  },
  {
    id: "4",
    name: "PixelBot",
    ...
    avatarUrl: null,
    comment:
      "Switched from Vegas Pro to Hume Editor last month. Half the price, twice the speed. Best decision for our team!",
  },
  {
    id: "5",
    name: "ByteBot",
    ...
    avatarUrl: null,
    comment:
      "The real-time collaboration feature lets our whole team edit together. It's transformed our post-production workflow.",
  },
];
